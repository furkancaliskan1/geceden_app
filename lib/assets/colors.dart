...
class AppColors {
  static Color appBackgroundColor =  const Color.fromRGBO(40, 40, 44, 1);
  ...
  static Color buttonBorderColor = const Color.fromRGBO(255, 255, 255, 0.7);
  static Color iconColor = const Color.fromRGBO(255, 255, 255, 0.3);
  static Color inputFieldBackgroundColor = const Color.fromRGBO(51, 53, 58, 0.6);
}