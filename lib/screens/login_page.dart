...
import 'package:app_geceden/screens/register_page.dart';
import 'package:app_geceden/widgets/button.dart';
import 'package:app_geceden/widgets/icon.dart';
import 'package:app_geceden/widgets/otp_form.dart';
import 'package:app_geceden/widgets/phone_field.dart';
                ...
                SizedBox(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Form(
                          key: _formKey,
                          child: PhoneField(controller: _phoneController, onChanged: (value) {
                 ...
                 AppButton(
                  ...
                  onPressed: () {
                    ...
                    if (_formKey.currentState?.validate() ?? false) { // phone alanı düzgün bir şekilde doldurulduysa
                      AuthService.sendOTP(
                                        ...
                                        onPressed: (){
                                          ...
                                          if (_otpKey.currentState?.validate() ?? false) {
                                            AuthService.loginWithOtp(otp: _otpController.text).then((value){
                                              if (value == 'true') {
                                                Navigator.pop(context); // loading için
                                                Navigator.pop(context); // bottompage için
